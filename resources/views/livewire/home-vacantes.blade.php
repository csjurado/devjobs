                ...
                @forelse ( $vacantes as $vacante)
                    <div class="md:flex md:justify-center md:items-center py-5"> 
                        <div class="md:flex-1">
                            ...
                            > {{ $vacante->titulo }}</a>
                            <p class="text-base text-gray-600 mb-3 my-3"> {{ $vacante->empresa }}</p>
                            <p class="text-xs font-bold text-gray-600 mb-1 my-3"> {{ $vacante->categoria->categoria }}</p>
                            <p class="text-base text-gray-600 mb-3 my-3"> {{ $vacante->salario->salario }}</p>
